...
class ControllerExtensionPaymentCoinpayments extends Controller
{
    ...
    public function index()
    {
        ...
        $data['url_action'] = $this->url->link('extension/payment/coinpayments', 'token=' . $this->session->data['token'], true);
        $data['url_cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=payment', true);
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/payment/coinpayments', 'token=' . $this->session->data['token'], true)
        );
        ...
        $this->response->setOutput($this->load->view('extension/payment/coinpayments.tpl', $data));
    }
