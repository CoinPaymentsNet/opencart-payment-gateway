...
class ControllerExtensionPaymentCoinpayments extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/coinpayments.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/extension/payment/coinpayments.tpl', $data);
        } else {
            return $this->load->view('/extension/payment/coinpayments.tpl', $data);
        }
    }
