                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="entry-client-id">
                                    <span data-toggle="tooltip" title="<?php echo $help_client_id; ?>">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="entry-client-secret">
                                    <span data-toggle="tooltip" title="<?php echo $help_client_secret; ?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-webhooks">
                                    <span data-toggle="tooltip" title="<?php echo $help_webhooks; ?>">
                                        <?php echo $entry_webhooks; ?>
                                    </span>
                                </label>
                                <div class="col-sm-10">
